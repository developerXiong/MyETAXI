 ...
 *  @param block    返回代码的block
 */
- (void)getFindNewPasswordWithPhoneNo:(NSString *)phone WithNewPassword:(NSString *)password validCode:(NSString *)validCode WithCompletion:(void(^)(NSString * returnCode,NSString * msg))block;
 ...
 *  @param block  返回代码的block
 */
- (void)getChangeNewPhoneWithPhoneNo:(NSString *)phone WithNewPhoneNo:(NSString *)nPhone WithType:(NSString *)type validCode:(NSString *)validCode WithCompletionBlock:(void(^)(NSString * returnCode,NSString * msg))block;
