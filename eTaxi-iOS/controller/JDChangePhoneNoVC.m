...
//            {
                MyData * data =[MyData new];
                [data getChangeNewPhoneWithPhoneNo:PHONENO WithNewPhoneNo:newPhoneTF.text WithType:@"1" validCode:confirmTF.text WithCompletionBlock:^(NSString *returnCode,NSString * msg) {
                    if ([returnCode intValue]==0)
                    {
