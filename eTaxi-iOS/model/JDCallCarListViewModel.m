...
-(void)setCallCarData:(JDCallCarData *)callCarData
{
    ...
    // 用车状态
    CGFloat sx = 0, sy = 0, sw = JDScreenSize.width, sh = 40;
    _statuViewFrame = CGRectMake(sx, sy, sw, sh);
    
    // 联系方式
    CGFloat px = 20, py = CGRectGetMaxY(_statuViewFrame)+5, pw = 75, ph = 18;
    _phoneNoLabelFrame = CGRectMake(px, py, pw, ph);
    
    _phoneNoFrame = CGRectMake(CGRectGetMaxX(_phoneNoLabelFrame)+10, py, [self textWidthWithHeight:ph textFont:[UIFont systemFontOfSize:20] Sting:phoneNoText], ph);
    
    _callPhoneFrame = CGRectMake(CGRectGetMaxX(_phoneNoFrame)+8, py, 16, 16);
    ...
    _cellHeight = CGRectGetMaxY(_destinationFrame)+20+112/2;
