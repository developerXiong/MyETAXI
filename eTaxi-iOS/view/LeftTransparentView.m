...
{
    NSArray * titles =[NSArray arrayWithObjects:@"积 分 明 细",@"兑 换 商 品",@"会 员 中 心",@"我 的 预 约",@"我 的 钱 包",@"我 的 营 收",@"邀 请 副 驾",@"使 用 说 明",@"设 置",@"关 于", nil];
    NSArray * imgNames =[NSArray arrayWithObjects:@"jifen_self",@"record_of_conversion_self",@"huiyuan_self",@"yuyue_self",@"qianbao-0_self",@"yingshou_self",@"yaoqing_self",@"shiyongshuoming_self",@"set_self",@"guanyu_self", nil];
